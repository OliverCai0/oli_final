...
def get_lighting(normal, view, ambient, light, symbols, reflect ):
    ...
    for lights in light:
        ...
        if first:
            d = calculate_diffuse(light_c, r, n)
            s = calculate_specular(light_c, r, view, n)
            first = False
        else:
        #a+b for a, b in zip(l1, l2)]
            d = [a+b for a,b in zip(d,calculate_diffuse(light_c, r, n))]
            s = [a+b for a,b in zip(d,calculate_specular(light_c, r, view, n))]
    #print(symbols['light'])
